...
} from "./chunk-M2W7ATCQ.js";
import {
  CssBaseline_default,
  body,
  html
} from "./chunk-NNCGEFUI.js";
import {
  IconButton_default,
  getIconButtonUtilityClass,
  iconButtonClasses_default
} from "./chunk-YIV3QLDH.js";
import {
...
import {
  ...
  useSnackbar,
  valueToPercent
} from "./chunk-IZCRPNIK.js";
import {
  GlobalStyles_default
} from "./chunk-DLQUTHXG.js";
import {
  useFormControl
...
} from "./chunk-3JIPGWJE.js";
import {
  Box_default,
  boxClasses_default
} from "./chunk-4NYE4LAK.js";
import {
  CssVarsProvider,
  ThemeProvider,
  adaptV4Theme,
  ...
  withStyles,
  withTheme
} from "./chunk-YBKW4LE5.js";
import {
  getOverlayAlpha_default,
  useTheme
} from "./chunk-UGHTYH7Y.js";
import {
...
} from "./chunk-DIXKWBBL.js";
import {
  Transition_default
} from "./chunk-5IMIEL5O.js";
import {
  require_react_dom
...
} from "./chunk-PSKBIO6G.js";
import {
  init_useForkRef as init_useForkRef2,
  useForkRef_default
} from "./chunk-U6F65DBV.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-IYVVY4ZB.js";
import {
  alpha,
  createContainer,
  createGrid,
...
} from "./chunk-5DBRIO2A.js";
import {
  init_styled,
  rootShouldForwardProp,
  slotShouldForwardProp,
  styled_default
} from "./chunk-UN3RS6VM.js";
import {
...
var Divider = React47.forwardRef(function Divider2(inProps, ref) {
  ...
  return (0, import_jsx_runtime56.jsx)(DividerRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    role,
    ref,
    ...
    children: children ? (0, import_jsx_runtime56.jsx)(DividerWrapper, {
      className: classes.wrapper,
      ownerState,
      children
    }) : null
...
var SliderTrack = styled_default("span", {
  ...
  const color = (
    ...
    theme.palette.mode === "light" ? (0, import_colorManipulator14.lighten)(theme.palette[ownerState.color].main, 0.62) : (0, import_colorManipulator14.darken)(theme.palette[ownerState.color].main, 0.5)
  );
  return _extends({
    display: "block",
    position: "absolute",
...
var SliderThumb = styled_default("span", {
  ...
  [`&:hover, &.${sliderClasses_default.focusVisible}`]: {
    boxShadow: `0px 0px 0px 8px ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.16)` : (0, import_colorManipulator14.alpha)(theme.palette[ownerState.color].main, 0.16)}`,
    "@media (hover: none)": {
      boxShadow: "none"
    }
  },
  [`&.${sliderClasses_default.active}`]: {
    boxShadow: `0px 0px 0px 14px ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.16)` : (0, import_colorManipulator14.alpha)(theme.palette[ownerState.color].main, 0.16)}`
  },
  [`&.${sliderClasses_default.disabled}`]: {
    "&:hover": {
      boxShadow: "none"
...
var Tooltip = React99.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React99.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime117.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = theme.direction === "rtl";
  ...
  return (0, import_jsx_runtime118.jsxs)(React99.Fragment, {
    children: [React99.cloneElement(children, childrenProps), (0, import_jsx_runtime117.jsx)(PopperComponent, _extends({
...
var Step = React105.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime125.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime124.jsxs)(React105.Fragment, {
...
var StepButton = React110.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React110.cloneElement(children, childProps) : (0, import_jsx_runtime132.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var SwipeableDrawer = React115.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime138.jsxs)(React115.Fragment, {
...
var SwitchSwitchBase = styled_default(SwitchBase_default, {
  ...
  [`&.${switchClasses_default.checked}`]: {
    color: (theme.vars || theme).palette[ownerState.color].main,
    "&:hover": {
      backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.hoverOpacity})` : (0, import_colorManipulator18.alpha)(theme.palette[ownerState.color].main, theme.palette.action.hoverOpacity),
      "@media (hover: none)": {
        backgroundColor: "transparent"
      }
    },
    [`&.${switchClasses_default.disabled}`]: {
      color: theme.vars ? theme.vars.palette.Switch[`${ownerState.color}DisabledColor`] : `${theme.palette.mode === "light" ? (0, import_colorManipulator18.lighten)(theme.palette[ownerState.color].main, 0.62) : (0, import_colorManipulator18.darken)(theme.palette[ownerState.color].main, 0.55)}`
    }
  },
  [`&.${switchClasses_default.checked} + .${switchClasses_default.track}`]: {
    backgroundColor: (theme.vars || theme).palette[ownerState.color].main
...
var Tab = React117.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime141.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime141.jsxs)(React117.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime141.jsxs)(React117.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
